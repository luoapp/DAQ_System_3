// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/ADADIO/ADADIO_Linux_3.x.x.x_GSC_DN/aout/main.c $
// $Rev: 1620 $
...
static int _parse_args(int argc, char** argv)
{
	...
	printf(" NOTE: At least one output channel must be specified.\n");
...
int main(int argc, char** argv)
{
	...
	{
		test	= time(NULL);
		printf("ADADIO Analog Output Sample (Version %s)\n", VERSION);
