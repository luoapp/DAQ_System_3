// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/ADADIO/ADADIO_Linux_3.x.x.x_GSC_DN/din/main.c $
// $Rev: 1620 $
...
int main(int argc, char** argv)
{
	...
	{
		test	= time(NULL);
		printf("ADADIO Digital Input Sample (Version %s)\n", VERSION);
