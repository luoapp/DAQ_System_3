// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/ADADIO/ADADIO_Linux_3.x.x.x_GSC_DN/sbtest/aout_strobe_enable.c $
// $Rev: 1620 $
...
/******************************************************************************
*
*	Function:	aout_strobe_enable_test
*
*	Purpose:
*
*		Perform a test of the IOCTL service ADADIO_IOCTL_AOUT_STROBE_ENABLE.
*
*	Arguments:
*
...
int aout_strobe_enable_test(int fd)
{
	...
	gsc_label("ADADIO_IOCTL_AOUT_STROBE_ENABLE");
