// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/16AO20/16AO20_Linux_2.x.x.x_GSC_DN/sbtest/clock_osc_src.c $
// $Rev: 2014 $
...
static int _function_test(int fd)
{
	static const service_data_t	list_1[]	=
	{
		...
		{					// Set Nclk low for the lowest possible Fref.
			/* service	*/	SERVICE_NORMAL,
			/* cmd		*/	AO20_IOCTL_NCLK,
			/* arg		*/	0x0,
			/* reg		*/	-1,
	...
	{
		{					// Select the 16MHz reference source.
			/* cmd		*/	SERVICE_NORMAL,
			/* arg		*/	AO20_IOCTL_CLOCK_OSC_SRC,
			/* reg		*/	AO20_CLOCK_OSC_SRC_ALT,
			/* mask		*/	0,
			/* value	*/	0
		},
	...
	// Here, it should take about 3.25 seconds for the buffer to empty.
...
/******************************************************************************
*
*	Function:	clock_osc_src_test
*
*	Purpose:
*
*		Perform a test of the IOCTL service AO20_IOCTL_CLOCK_OSC_SRC.
*
*	Arguments:
*
...
int clock_osc_src_test(int fd)
{
	...
	gsc_label("AO20_IOCTL_CLOCK_OSC_SRC");
