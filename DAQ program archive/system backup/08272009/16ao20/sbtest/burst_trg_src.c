// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/16AO20/16AO20_Linux_2.x.x.x_GSC_DN/sbtest/burst_trg_src.c $
// $Rev: 2014 $
...
static int _function_test(int fd)
{
	static const service_data_t	list[]	=
	{
		...
		// Verify software burst triggering.
	...
	// We only test the SOFTWARE source as testing the EXTERNAL source requires
...
/******************************************************************************
*
*	Function:	burst_trg_src_test
*
*	Purpose:
*
*		Perform a test of the IOCTL service AO20_IOCTL_BURST_TRIG_SRC.
*
*	Arguments:
*
...
int burst_trg_src_test(int fd)
{
	...
	gsc_label("AO20_IOCTL_BURST_TRIG_SRC");
