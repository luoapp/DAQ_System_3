// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/16AO20/16AO20_Linux_2.x.x.x_GSC_DN/sbtest/nclk.c $
// $Rev: 2014 $
...
static int _function_test(int fd)
{
	...
	{
		{					// Set Nclk high for the highest possible Fref.
			/* service	*/	SERVICE_NORMAL,
			/* cmd		*/	AO20_IOCTL_NCLK,
			/* arg		*/	0x1FF,
			/* reg		*/	-1,
...
*	Purpose:
*
*		Perform a test of the IOCTL service AO20_IOCTL_NCLK.
*
*	Arguments:
*
