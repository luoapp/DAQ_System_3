...
*/
  ...
  */
  ...
  outbuffer = daqMallocAligned( outbuffer, board.ctl.octl.nburst * board.ctl.octl.nchans*sizeof(unsigned int) );
 ...
 // allocate an input data buffer (alignment is optional)
  inbuffer = daqMallocAligned( inbuffer, board.ctl.ictl.nburst * board.ctl.ictl.nchans*sizeof(unsigned int) );
  //inbuffer = malloc( board.ctl.ictl.nburst * board.ctl.ictl.nchans*sizeof(unsigned int) );
  u16buff  = malloc( board.ctl.ictl.nburst * board.ctl.ictl.nchans*sizeof(unsigned short) );
  ...
  retv = daqWriteReadRaw( &board, outbuffer, board.ctl.octl.nburst, 
			  inbuffer, board.ctl.ictl.nburst,
