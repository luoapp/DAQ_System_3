// $URL: http://subversion:8080/svn/gsc/trunk/drivers/LINUX/16AO20/16AO20_Linux_2.x.x.x_GSC_DN/sbtest/sample_mode.c $
// $Rev: 2014 $
...
/******************************************************************************
*
*	Function:	sample_mode_test
*
*	Purpose:
*
*		Perform a test of the IOCTL service AO20_IOCTL_SAMPLE_MODE.
*
*	Arguments:
*
...
int sample_mode_test(int fd)
{
	...
	gsc_label("AO20_IOCTL_SAMPLE_MODE");
